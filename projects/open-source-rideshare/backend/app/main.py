...
from app.api.v1 import accessibility, admin, admin_financials, admin_ride_export, airport_queue, analytics, announcements, audit, auth, background_checks, blocklist, board_elections, bulk_notifications, busy_hours, cancellation_policies, chat, complaints, cooperative, corporate, corporate_account_contacts, corporate_account_contracts, corporate_account_dashboard, corporate_account_notes, corporate_account_suspensions, corporate_account_tags, corporate_accounts, corporate_addresses, corporate_admin_audit_log, corporate_api_keys, corporate_approval_chains, corporate_auto_approval_rule, corporate_batch_booking, corporate_billing_contacts, corporate_billing_settings, corporate_blackout_periods, corporate_booking_eligibility, corporate_budget_alerts, corporate_carbon_budget, corporate_commuter_benefits, corporate_cost_center, corporate_credit_accounts, corporate_custom_fields, corporate_data_export, corporate_delegates, corporate_department_ride_policy, corporate_departments, corporate_driver_pool, corporate_employee_expense, corporate_employee_group, corporate_employee_invitations, corporate_events, corporate_expense_reports, corporate_fare_agreements, corporate_guest_pass, corporate_health_score, corporate_invoice, corporate_invoice_disputes, corporate_manager_hierarchy, corporate_member_policy_overrides, corporate_member_ride_quota, corporate_notification_settings, corporate_onboarding_checklist, corporate_policy_violations, corporate_receipt_template, corporate_ride_approval, corporate_ride_policy, corporate_ride_templates, corporate_scheduled_reports, corporate_shifts, corporate_spending_analytics, corporate_sso_config, corporate_travel_itineraries, corporate_trip_purpose, corporate_webhooks, demand_heatmap, device_tokens, document_expiry, driver_availability, driver_certifications, driver_destination, driver_documents, driver_dividends, driver_earnings_goals, driver_earnings_guarantee, driver_earnings_summary, driver_expenses, driver_incidents, driver_insurance, driver_languages, driver_location, driver_mentorship, driver_onboarding, driver_performance, driver_payouts, driver_proposals, driver_quest, driver_rating_appeals, driver_referrals, driver_shifts, driver_subscriptions, driver_tax, driver_tiers, driver_incentive_zones, driver_work_preferences, drivers, fare_disputes, fare_splits, hardship_fund, incentives, lost_and_found, lost_found, notification_preferences, notifications, partner_orgs, payments, payouts, platform_config, pools, privacy, promos, receipts, recurring_rides, ride_carbon, ride_feedback, ride_preferences, rider_cooperative, rider_memberships, rider_ratings, rider_referrals, rider_rewards, rides, safety, safety_alerts, saved_locations, scheduled_rides, service_areas, surge_price_lock, tips, trip_heatmap, trusted_contacts, vehicle_inspection, vehicle_maintenance, vehicles, waypoints
...
app.include_router(corporate_invoice_disputes.router, prefix="/api/v1")
app.include_router(corporate_onboarding_checklist.router, prefix="/api/v1")
app.include_router(corporate_account_contracts.router, prefix="/api/v1")
...
app.include_router(corporate_employee_group.router, prefix="/api/v1")
app.include_router(corporate_commuter_benefits.router, prefix="/api/v1")
app.include_router(corporate_billing_settings.router, prefix="/api/v1")
app.include_router(corporate_carbon_budget.router, prefix="/api/v1")
app.include_router(corporate_account_suspensions.router, prefix="/api/v1")
app.include_router(corporate_health_score.router, prefix="/api/v1")
app.include_router(corporate_account_notes.router, prefix="/api/v1")
app.include_router(corporate_account_tags.router, prefix="/api/v1")
app.include_router(corporate_member_ride_quota.router, prefix="/api/v1")
app.include_router(corporate_policy_violations.router, prefix="/api/v1")
app.include_router(corporate_approval_chains.router, prefix="/api/v1")
app.include_router(corporate_manager_hierarchy.router, prefix="/api/v1")
app.include_router(corporate_member_policy_overrides.router, prefix="/api/v1")
app.include_router(corporate_receipt_template.router, prefix="/api/v1")
app.include_router(corporate_travel_itineraries.router, prefix="/api/v1")
app.include_router(corporate_events.router, prefix="/api/v1")
app.include_router(corporate_shifts.router, prefix="/api/v1")
app.include_router(corporate_ride_templates.router, prefix="/api/v1")
app.include_router(corporate_auto_approval_rule.router, prefix="/api/v1")
app.include_router(corporate_department_ride_policy.router, prefix="/api/v1")
app.include_router(corporate_booking_eligibility.router, prefix="/api/v1")
