...
app.include_router(driver_document_expiry.router, prefix="/api/v1")
...
app.include_router(driver_arrival.router, prefix="/api/v1")
app.include_router(ride_live_status.router, prefix="/api/v1")
