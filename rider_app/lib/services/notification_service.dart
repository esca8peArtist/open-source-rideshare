...
import 'package:rideshare_rider/router.dart' show navigatorKey;
import 'package:rideshare_rider/services/api_client.dart';

/// Handles Firebase Cloud Messaging push notifications for the rider app.
///
/// Usage:
...
class NotificationService {
  ...
  static String? _routeFromMessage(RemoteMessage message) {
    ...
    switch (type) {
      ...
      case 'ride_completed':
        return rideId != null ? '/ride/$rideId/rate' : '/history';
      case 'ride_cancelled':
        return '/';
      case 'payment_received':
      case 'fare_split_request':
        return rideId != null ? '/ride/$rideId' : '/history';
      case 'ride_reminder':
        return rideId != null ? '/ride/$rideId' : '/';
      default:
        return null;
